    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
						...
						<div class="container" style="padding-top:5%;">
							<div class="row">
								<div class="col-sm-12">
									<center><h4>Lista e kontakteve te derguara nga vizitoret e faqes:</h4></center>
									<br/>
									<table class="table table-striped">
										<thead>
											<tr>
												...
												<th scope="col">E-mail Title</td>
												<th scope="col">Mesazhi</td>
											</tr>
										</thead>
										<tbody>
											...
											<tr>
												...
												<th scope="row">{{ $value->emailtitle }}</td>
												<th scope="row">{{ $value->mesazhi }}</td>
											</tr>
											@endforeach
										</tbody>
									</table>
