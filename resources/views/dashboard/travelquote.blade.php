    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
						...
						<div class="container" style="padding-top:5%;">
							<div class="row">
								<div class="col-sm-12">
									<center><h4>Lista e Travel Quote:</h4></center>
									<br/>
									<table class="table table-striped">
										<thead>
											<tr>
												<th scope="col">#</td>
												<th scope="col">Protection</td>
												<th scope="col">Full Name</td>
												<th scope="col">Persons</td>
												<th scope="col">Phone Number</td>
												<th scope="col">E-mail</td>
												<th scope="col">Destination</td>
												<th scope="col">How Long</td>
											</tr>
										</thead>
										<tbody>
											...
											<tr>
												...
												<th scope="row">{{ $value->protection }}</td>
												<th scope="row">{{ $value->fullname }}</td>
												<th scope="row">{{ $value->persons }}</td>
												<th scope="row">{{ $value->number }}</td>
												<th scope="row">{{ $value->email }}</td>
												<th scope="row">{{ $value->destination }}</td>
												<th scope="row">{{ $value->howlong }}</td>
											</tr>
											@endforeach
										</tbody>
									</table>
