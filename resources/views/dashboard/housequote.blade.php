    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
						...
						<div class="container" style="padding-top:5%;">
							<div class="row">
								<div class="col-sm-12">
									<center><h4>Lista e House Quote:</h4></center>
									<br/>
									<table class="table table-striped">
										<thead>
											<tr>
												<th scope="col">#</td>
												<th scope="col">Sort Of Property</td>
												<th scope="col">Type Of Property</td>
												<th scope="col">When it's Builded</td>
												<th scope="col">Post Code</td>
										...
										<tbody>
											...
											<tr>
												...
												<th scope="row">{{ $value->sortproperty }}</td>
												<th scope="row">{{ $value->typeproperty }}</td>
												<th scope="row">{{ $value->whenbuilt }}</td>
												<th scope="row">{{ $value->postcode }}</td>
												<th scope="row">{{ $value->fullname }}</td>
												<th scope="row">{{ $value->yourage }}</td>
